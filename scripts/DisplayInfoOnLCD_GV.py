...
##           - An example from Display Progress:  1/200 | ET 9h17m.  If there are pauses in the file and the option is chosen it could be: 1/200 | TP 2h36m
...
class DisplayInfoOnLCD_GV(Script):
    ...
    def getSettingDataString(self):
        return """{
            "name": "Display Info on LCD GV",
            "key": "DisplayInfoOnLCD_GV",
            "metadata": {},
            "version": 2,
            "settings":
            {
                ...
                "countdown_to_pause":
                {
                    ...
                    "description": "Instead of the remaining print time the LCD will show the estimated time to the next layer that has a pause (TP).",
                    "type": "bool",
                    "default_value": false,
